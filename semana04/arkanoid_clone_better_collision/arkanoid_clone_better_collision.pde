...
void draw() {
  ...
  player.setX(mouseX - player.w / 2);
  player.setY(mouseY - player.h / 2);
...
void checkCollision() {
  ...
  if (ball.y + ball.getHeight() > height) {
    ball.changeDirectionY();
    ball.y = height - ball.h - 0.01;
  }
  ...
  if (AABB(player, ball)) {
    ...
    switch (side) {
      case 0:
        ball.changeDirectionY();
        //ball.y += 0.01 * ball.dy;
        ball.y = player.y - ball.h - 0.01;
        break;
      case 1:
        ball.changeDirectionY();
        //ball.y += 0.01 * ball.dy;
        ball.y = player.y + player.h - 0.01;
        break;
      case 2:
        ball.changeDirectionX();
        //ball.x += 0.01 * ball.dx;
        ball.x = player.x - ball.w - 0.01;
        break;
      case 3:
        ball.changeDirectionX();
        //ball.x += 0.01 * ball.dx;
        ball.x = player.x + player.w - 0.01;
        break;
    }
  } //<>// //<>// //<>// //<>//
}
